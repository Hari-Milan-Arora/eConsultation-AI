...
async def submit_comment(comment: CommentInput):
    ...
    try:
        ...
        log_error_safely(e, "submit_comment")
...
async def submit_bulk_comments(file: UploadFile = File(...)):
    ...
    try:
        ...
        log_error_safely(e, "submit_bulk_comments")
...
async def get_all_comments(limit: int = 100, offset: int = 0):
    ...
    try:
        ...
        comments = []
        for row in rows:
            # Ensure summary meets 50 character limit
            summary = row[6] or ""
            if len(summary) > 50:
                summary = summary[:47] + "..."
            ...
            comments.append(CommentResponse(
                ...
                raw_text=row[3][:300] if row[3] else "",  # Ensure 300 char limit
        ...
        log_error_safely(e, "get_all_comments")
...
async def get_dashboard_stats():
    ...
    try:
        ...
        log_error_safely(e, "get_dashboard_stats")
...
async def generate_wordcloud(sentiment: str = None):
    ...
    try:
        ...
        log_error_safely(e, "generate_wordcloud")
